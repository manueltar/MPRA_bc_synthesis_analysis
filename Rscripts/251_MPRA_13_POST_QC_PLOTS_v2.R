...
ggridge.graphs = function(option_list)
{
  ...
  MPRA_Real_tile_subset<-unique(MPRA_Real_tile[which(MPRA_Real_tile$QC2_CLASS == "PASS"),c(which(colnames(MPRA_Real_tile) == "REAL_TILE_Plus_carried_variants"),
                                                                                           which(colnames(MPRA_Real_tile) == "Cell_Type"),which(colnames(MPRA_Real_tile) == "factor4"),
                                                                                    which(colnames(MPRA_Real_tile) == "Label"),which(colnames(MPRA_Real_tile) == "Label_2"),
  ...
  cat(sprintf(as.character(names(summary(as.factor(MPRA_Real_tile_subset$Label))))))
  cat("\n")
  cat(sprintf(as.character(summary(as.factor(MPRA_Real_tile_subset$Label)))))
  cat("\n")
  cat(sprintf(as.character(names(summary(as.factor(MPRA_Real_tile_subset$DEF_CLASS))))))
  cat("\n")
  cat(sprintf(as.character(summary(as.factor(MPRA_Real_tile_subset$DEF_CLASS)))))
  cat("\n")
  
  MPRA_Real_tile_subset_enhancer<-MPRA_Real_tile_subset[which(MPRA_Real_tile_subset$DEF_CLASS == "enhancer" |
                                                                MPRA_Real_tile_subset$DEF_CLASS == "E_Plus_ASE"),]
  
  MPRA_Real_tile_subset_enhancer<-droplevels(MPRA_Real_tile_subset_enhancer)
  
  cat("MPRA_Real_tile_subset_enhancer_\n")
  cat(str(MPRA_Real_tile_subset_enhancer))
  cat("\n")
  
  cat(sprintf(as.character(names(summary(as.factor(MPRA_Real_tile_subset_enhancer$Label))))))
  cat("\n")
  cat(sprintf(as.character(summary(as.factor(MPRA_Real_tile_subset_enhancer$Label)))))
  cat("\n")
  cat(sprintf(as.character(names(summary(as.factor(MPRA_Real_tile_subset_enhancer$DEF_CLASS))))))
  cat("\n")
  cat(sprintf(as.character(summary(as.factor(MPRA_Real_tile_subset_enhancer$DEF_CLASS)))))
  cat("\n")
  
  
  MPRA_Real_tile_subset_ASE<-MPRA_Real_tile_subset[which(MPRA_Real_tile_subset$DEF_CLASS == "ASE" |
                                                                MPRA_Real_tile_subset$DEF_CLASS == "E_Plus_ASE"),]
  
  MPRA_Real_tile_subset_ASE<-droplevels(MPRA_Real_tile_subset_ASE)
  
  cat("MPRA_Real_tile_subset_ASE_\n")
  cat(str(MPRA_Real_tile_subset_ASE))
  cat("\n")
  
  cat(sprintf(as.character(names(summary(as.factor(MPRA_Real_tile_subset_ASE$Label))))))
  cat("\n")
  cat(sprintf(as.character(summary(as.factor(MPRA_Real_tile_subset_ASE$Label)))))
  cat("\n")
  cat(sprintf(as.character(names(summary(as.factor(MPRA_Real_tile_subset_ASE$DEF_CLASS))))))
  cat("\n")
  cat(sprintf(as.character(summary(as.factor(MPRA_Real_tile_subset_ASE$DEF_CLASS)))))
  cat("\n")
  ...
  Rosetta_df<-Rosetta_df[which(Rosetta_df$REAL_TILE_Plus_carried_variants%in%MPRA_Real_tile_subset$REAL_TILE_Plus_carried_variants),]
  
  Rosetta_df<-droplevels(Rosetta_df)
  ...
  for(i in 1:length(features))
  {
    ...
    list_values_sel<-list_values_sel[which(list_values_sel$REAL_TILE_Plus_carried_variants%in%MPRA_Real_tile_subset$REAL_TILE_Plus_carried_variants),]
    
    list_values_sel<-droplevels(list_values_sel)
    ...
    if(features_sel == "LogFC")
    {
      ...
      ggridge_plot<-list_values_sel[order(list_values_sel$Cell_Type,list_values_sel$master_sample),] %>%
      ...
      list_values_sel_subset<-list_values_sel[which(list_values_sel$REAL_TILE_Plus_carried_variants%in%MPRA_Real_tile_subset_enhancer$REAL_TILE_Plus_carried_variants),]
      ...
      ggridge_plot<- list_values_sel_subset[order(list_values_sel_subset$Cell_Type,list_values_sel_subset$master_sample),] %>%
...
corr.graphs = function(option_list)
{
  ...
  for(i in 1:length(features))
  {
    ...
    cat(str(df.color_Cell_Type))
    cat("\n")
    cat(sprintf(as.character(names(summary(df.color_Cell_Type$Cell_Type)))))
    cat("\n")
    cat(sprintf(as.character(summary(df.color_Cell_Type$Cell_Type))))
    cat("\n")
    ...
    levels_Cell_Type<-levels(h2_h3_df$Cell_Type)
    ...
    melted_cormat<-melted_cormat[order(melted_cormat$Cell_Type),]
